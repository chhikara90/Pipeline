    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        <motion.p
          ...
          className="text-primary font-display font-semibold tracking-widest uppercase text-sm mb-6"
        >
        ...
        >
          Outbound Systems That{" "}
          <span className="gradient-text">Maximize Qualified Conversations</span>
        </motion.h1>
        ...
        >
          PipelineScaler builds and operates outbound pipelines for high-LTV businesses.
          We don't sell leads. We create predictable conversation flow through
          proven outbound execution.
        </motion.p>
